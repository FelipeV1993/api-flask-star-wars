...
from models import db, User, People, Planets, Vehicles, Favorites_People, Favorites_vehicles, Favorites_planets
...
def list_and_create_planets():
    ...
    if request.method =="POST":
        ...
        # planets.diameter = data["diameter"]
        # planets.climate = data["climate"]
        # planets.gravity = data["gravity"]
        # planets.terrain = data["terrain"]
        # planets.surface_water = data["surface_water"]
...
def list_and_create_vehicles():
    ...
    if request.method =="POST":
        ...
        # vehicles.length = data["length"]
        # vehicles.max_atmosphering_speed = data["max_atmosphering_speed"]
        # vehicles.crew = data["crew"]
        # vehicles.passengers = data["passengers"]
